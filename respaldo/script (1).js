...
// CORREGIDO: Eliminamos el fragmento "<drawPlot1(); drawPlot2();" que estaba pegado al <p>
...
// LLAMADA INICIAL A LOS GRÁFICOS (Para que se vean al cargar)
  drawPlot1();
  drawPlot2();
  updatePlot(speciesList[0]);

// Evento del botón Enter
 ...
 const langToggle = document.getElementById("langToggle");
  ...
  function changeLanguage() {
    ...
    drawPlot2();
    updateAllTitles();
// ... resto de la lógica de copyright ...
  }
});
